...
const Integrations = () => {
  ...
  // Filter integrations based on search term with error handling
  const filteredIntegrations = useMemo(() => {
    try {
      ...
      console.error('Error filtering integrations:', err);
      setError('An error occurred while filtering integrations.');
      return [];
    }
  }, [searchTerm]);
